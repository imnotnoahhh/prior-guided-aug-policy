...
To ensure full reproducibility, we provide specific settings in the code\footnote{Code available at: \url{https://github.com/imnotnoahhh/Rethinking-Augmentation}}.
