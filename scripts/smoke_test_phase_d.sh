#!/usr/bin/env bash
# =============================================================================
# Smoke Test Script for Phase D: SOTA Benchmark Comparison
# =============================================================================
...
print_step 4 $TOTAL_STEPS "Testing all Phase D transforms"
python -c "
...
# Step 6: Run dry-run Phase D (minimal epochs, 2 methods, 1 fold)
print_step 6 $TOTAL_STEPS "Running Phase D dry-run (2 epochs, 2 methods, 1 fold)"
...
echo "  CUDA_VISIBLE_DEVICES=0 python main_phase_d.py"
echo ""
