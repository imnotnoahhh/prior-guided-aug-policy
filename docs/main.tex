...
\begin{table}[htbp] % 建议把 [htbp] 改成 [htbp] 以免排版出错，如果你非要固定位置可以用 [htbp]
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{lccc}
            ...
            \midrule
            \textbf{SAS (ColorJitter)} & 40.74 & \textbf{0.78} & \textbf{Low (Single)} \\
            \bottomrule
        \end{tabular}
    }
\end{table}
