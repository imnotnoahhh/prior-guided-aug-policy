...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{../outputs/figures/augment_examples/all_augmentations_grid.png}
...
\begin{figure}[H]
    ...
    \caption{\textbf{Generalization Performance.} Comparison on CIFAR-10 (50-shot). Our method achieves robustness comparable to state-of-the-art while maintaining zero variance across folds, outperforming the unaugmented baseline.}
